...
We run the halogenOS Group Assistant in halogenOS chat groups and in direct chats with it.
This notice is given under Articles 13 and 14 GDPR.
...
project's public sources with the result it received. We do not store the media itself,
edits, or posts made anonymously for the group, except a pinned rules text.
...
identity data and your administrator standing from the chat platform, the title and rules
from the group, a report from the member who asked for it. We take nothing about you from
anywhere else.
...
identity data and circumstances as long as the message; the title and pinned rules while
the assistant serves the group, each replaced by the next; answer counters until they fall
...
your whole direct conversation with the assistant, and your identity data. What remains in a
...
beyond our reach. We do not reach lookup records, the title and pinned rules text, or the
