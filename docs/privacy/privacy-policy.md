...
- Our processor is a UK company, though it stores and serves in Frankfurt. The European
  ...
  safeguard is needed.
- Where a model deployment sits outside the EEA, the request reaches it there, under the
  standard contractual clauses in the processor agreement (Article 46(2)(c) GDPR). Write to
  the address above for a copy.
