...
flag stands is EMPTIED — the username to its typed absence; no display
name exists to empty since decision 0077 — instead of deleted, so the
flag survives its own person's deletion. For an unflagged person nothing
changes.
